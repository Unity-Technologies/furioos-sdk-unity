...
namespace Rise.Core {
	...
	public abstract class RSOutput : RSUniqueBehaviour {

		public delegate void OnActivatedHandler(RSOutput o);
		public delegate void OnDesactivatedHandler(RSOutput o);
