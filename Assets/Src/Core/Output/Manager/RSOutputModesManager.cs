...
namespace Rise.Core {
	public class RSOutputModesManager : RSAppManagerModule{
		...
		{	
			return RSManager.GetAllInstances<RSOutputMode>();
		}
		...
		{
			AppManager.SetSetting("OutputModeType",outputMode.GetType());
		...
		public RSOutputMode ActivateOutputMode(string id){
			...
			RSOutputMode newOutputMode = RSManager.GetInstance<RSOutputMode>(id);
		...
		public void DesactivateAllOutputModes(){
			List<RSOutputMode> outputModes = RSManager.GetAllInstances<RSOutputMode>();
