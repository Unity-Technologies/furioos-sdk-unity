	...
	public class RSFingerTouch {
		...
		public bool IsActive{
			...
			set{
				...
				if(!value && isActive) HasGoneInactive = true;
				isActive = value;
			}
		}
		...
		public bool IsMoving{
			get { return IsActive && !HasGoneActive;}

		}

		public RSFingerTouch(){
			Id = -1;
		}
		
		//You have to call UpdatePosition or Move only once per frame
		public void UpdatePosition(float px, float py){
			...
			if(IsMoving)distance+=delta.magnitude;
			//Debug.Log("Updating  touch ("+Id+")");
		}
