...
public class Scatter  : MonoBehaviour{
	...
	public int maxObjectsCount = 500;
	...
	public void Start () {
		...
		for(int i = 0;i<triangles.Length;i+=3){
			...
			Vector2 uv1 = srcMesh.uv2[triangles[i]];
			Vector2 uv2 = srcMesh.uv2[triangles[i+1]];
			Vector2 uv3 = srcMesh.uv2[triangles[i+2]];
			...
			if(numItemsToAdd>0){
				...
				if(sampleObjects.Length==1){
						...
						newGameObject.GetComponent<Renderer>().material = instantiateGameObject[0].GetComponent<Renderer>().material;
