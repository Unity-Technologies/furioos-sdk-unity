...
namespace Rise.Core {
	public class RSMovingModesManager : RSSceneManagerModule {
		...
		{	
			return RSSceneManager.GetAllInstances<RSMovingMode>();
		}
		...
		public RSMovingMode ActivateMovingMode(string id){
			RSMovingMode newMovingMode = RSSceneManager.GetInstance<RSMovingMode>(id);
		...
		public void DesactivateAllMovingModes(){
			List<RSMovingMode> movingModes = RSSceneManager.GetAllInstances<RSMovingMode>();
