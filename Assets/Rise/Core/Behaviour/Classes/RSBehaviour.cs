...
namespace Rise.Core {
		...
		: MonoBehaviour
	{
		...
		public virtual RSSceneManager SceneManager {
			get { return RSSceneManager.SceneManagerInstance ; }
		}

		public virtual RSInputManager InputManager {
			get { return RSSceneManager.SceneManagerInstance!= null ? RSSceneManager.SceneManagerInstance.InputManager : null; }
		}

		public virtual RSOutputModesManager OutputModesManager {
			get { return RSSceneManager.SceneManagerInstance!= null ? RSSceneManager.SceneManagerInstance.OutputModesManager : null; }
		}

		public virtual RSMovingModesManager MovingModesManager {
			get { return RSSceneManager.SceneManagerInstance!= null ? RSSceneManager.SceneManagerInstance.MovingModesManager : null; }
		}
		...
		public virtual Camera UiCamera {
			get { 
				if(uiCamera != null) {
					...
					uiCamera = RSSceneManager.GetInstance<RSUICamera>().GetComponent<Camera>();
		...
		protected virtual void Init()
		{
			...
			if(string.IsNullOrEmpty(id)){
				id = RSSceneManager.GetUnique(GetType().ToString());
			}

			RSSceneManager.Register(this);
		}
		...
		public virtual void OnDestroy () {
			RSSceneManager.Unregister(this);
		}
