...
{
internal class OBSStandardShaderGUI : ShaderGUI
{
	...
	private static class Styles
	{
		...
		public static GUIContent cullModeLabel = new GUIContent ("Cull Mode");
		public static GUIContent antiFlickLabel = new GUIContent ("Anti Flick");
		...
		public static string renderingSettings = "Rendering Settings";
	...
	MaterialProperty antiFlick = null;
	...
	public void FindProperties (MaterialProperty[] props)
	{
		...
		antiFlick = FindProperty ("_AntiFlick", props);
	...
	public void ShaderPropertiesGUI (Material material)
	{
		...
		{	
			GUILayout.Label (Styles.renderingSettings, EditorStyles.boldLabel);
			BlendModePopup();
			
			m_MaterialEditor.ShaderProperty(cullMode, Styles.cullModeLabel.text);
			m_MaterialEditor.ShaderProperty(antiFlick, Styles.antiFlickLabel.text);
