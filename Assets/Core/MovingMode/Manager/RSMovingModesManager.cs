...
namespace Rise.Core {
	public class RSMovingModesManager : RSAppManagerModule {
		...
		{	
			return RSAppManager.GetAllInstances<RSMovingMode>();
		}
		...
		public RSMovingMode ActivateMovingMode(string id){
			RSMovingMode newMovingMode = RSAppManager.GetInstance<RSMovingMode>(id);
		...
		public void DesactivateAllMovingModes(){
			List<RSMovingMode> movingModes = RSAppManager.GetAllInstances<RSMovingMode>();
