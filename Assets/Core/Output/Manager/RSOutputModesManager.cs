...
namespace Rise.Core {
	public class RSOutputModesManager : RSAppManagerModule{
		...
		{	
			return RSAppManager.GetAllInstances<RSOutputMode>();
		}
		...
		public RSOutputMode ActivateOutputMode(string id){
			...
			RSOutputMode newOutputMode = RSAppManager.GetInstance<RSOutputMode>(id);
		...
		public void DesactivateAllOutputModes(){
			List<RSOutputMode> outputModes = RSAppManager.GetAllInstances<RSOutputMode>();
